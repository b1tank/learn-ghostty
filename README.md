...
The published path now contains the first Zig process, App ownership, build-selected entry routing, and the runtime/Surface split. Later chapters are written only after the previous checkpoint is learned and validated.
