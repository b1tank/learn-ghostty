...
The published path now contains the first Zig process, App ownership lifecycle, and build-selected Ghostty entry routing. Later chapters are written only after the previous checkpoint is learned and validated.
