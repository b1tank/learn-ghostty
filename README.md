...
The published path now contains the first Zig process, App ownership, entry routing, runtime/Surface split, and a measured ordinary-pipes child-process limitation. Later chapters are written only after the previous checkpoint is learned and validated.
