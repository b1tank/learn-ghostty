...
Each `src/content/lessons/*.mdx` file defines order, title, summary, duration, module, status, and source references. Astro derives homepage roadmap, sidebar, previous/next navigation, search, and AI Markdown from that collection.
