...
- [ ] **1. Establish one canonical learning model**
...
- [ ] **2. Replace the marketing dashboard with a learner cockpit**
...
- [ ] **3. Compress Lesson 00 into a sharp orientation**
...
- [ ] **4. Build a real process-and-PTY observation mission**
...
- [ ] **5. Build an input-driven byte-to-screen workbench**
...
- [ ] **6. Make progress require learner-produced evidence**
...
- [ ] **7. Audit the redesigned learning journey**
...
_Record blockers, workarounds, and final verification evidence here._
