...
const referenceHref = computed(() => `${import.meta.env.BASE_URL}zig-for-c/#${props.reference}`);
...
<template>
  <section ref="root" class="syntax-bridge">
    <header>
      ...
      <a class="syntax-bridge__reference" :href="referenceHref">Open in the cumulative Zig/C reference</a>
    </header>
