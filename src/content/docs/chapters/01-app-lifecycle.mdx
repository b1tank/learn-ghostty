...
## Why not keep everything in `main`?
...
## Real Ghostty ran into the same problem
...
## Open `App.zig`: what kind of thing is App?
...
## Return to `main.zig` and follow the calls
...
## How does today's Ghostty use this idea?
