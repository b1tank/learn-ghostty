...
description: Trace terminal data across two kernels, an encrypted network channel, a remote PTY, and optionally another terminal multiplexer.
...
<LessonActions entryId="field-guides/ssh-remote" />
