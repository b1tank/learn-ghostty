...
Next you will stop treating “output bytes” as an abstraction. You will type or choose byte sequences, predict the result, and step a miniature terminal one byte at a time. Every step will expose parser interpretation, cursor movement, style, and grid mutation.
