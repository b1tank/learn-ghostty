...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        { label: "Rebuild Ghostty", items: ["chapters/00-process-exists", "chapters/01-app-lifecycle", "chapters/02-entry-routing", "chapters/03-runtime-surface", "chapters/04-child-process-pipes"] },
